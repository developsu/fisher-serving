...
from torchvision.models.detection.faster_rcnn import FasterRCNN, FastRCNNConvFCHead, RPNHead, _default_anchorgen
...
# class Before_keypoint_roi_pool_detach:
#     def __call__(self):
#         return self.detach()


class Mask_kpt_RCNN(FasterRCNN):
    """
    ...
    def __init__(
        ...
        mask_predictor=None,
        # keypoint parameters
        # before_keypoint_roi_pool_detach=None,
        ...
        **kwargs,
        ...
        # if before_keypoint_roi_pool_detach is None:
        #     before_keypoint_roi_pool_detach = Before_keypoint_roi_pool_detach()
        ...
        # self.roi_heads.before_keypoint_roi_pool_detach = before_keypoint_roi_pool_detach
...
class Mask_RCNN_ResNet50_FPN_Weights(WeightsEnum):
    COCO_V1 = Weights(
...
def mask_kpt_rcnn_resnet50_fpn(
    *,
    ...
    **kwargs: Any,
    ...
    model = Mask_kpt_RCNN(backbone, num_classes=num_classes, num_keypoints=num_keypoints, **kwargs)
